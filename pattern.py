...
for w_fear, w_surprise, w_anger in weight_patterns:
    ...
    class_weights = {list_face_expression.index('happy'): 1.0, 
    ...
    y_pred_prob = model.predict(X_test_processed, batch_size=8)
    ...
    # === 混同行列 (Confusion Matrix) のプロットと保存 ===
